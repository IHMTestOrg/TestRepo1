...
export const FLAME_STRIKE_SMALL = std.Spells
    .create('tswow-necromancer','flame-strike-small',42926)
    .CastTime.set(0,0,0)
    .Visual.Kits.PersistentArea.BaseEffect.set(SMALL_STRIKE_SCALE.ID.get())

export const FLAME_STRIKE = std.Spells
    .create('tswow-necromancer','flame-strike',42926)
